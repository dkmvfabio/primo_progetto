...
def queryBase(request):
    ...
    #4. Ordinare gli articoli che non hanno visualizzazioni:
    ...
    in base al campo visualizzazioni nel modello Articolo. La notazioni articoli__visualizzazioni indica
    ...
    il criterio, e vogliamo ottenere solo una volta ogni giornalista che ha scrittto almeno un articolo popolare.
    '''
    ...
    #18. Articoli dopo una certa data e con un minimo di visualizzazioni
    ...
    #19. Articoli dopo una certa data o con un massimo di visualizzioni
